<Cabbage>
form size(800, 510), caption("Stats rope"), pluginId("str8"), guiMode("queue"), colour(30,30,30)
...
rslider channel("detune"), bounds(10, 80, 70, 70), text("Detune"), range(0, 1, 0.1, 0.35)

rslider channel("chroma"), bounds(70, 80, 70, 70), text("Chroma"), range(0, 1, 0.1, 0.35)

rslider channel("Grate"), bounds(10, 150, 70, 70), text("Grate"), range(0.5, 20, 4, 0.35)
rslider channel("Gdur"), bounds(70, 150, 70, 70), text("Gdur"), range(0.1, 2, 1, 0.35)


button channel("Wave_raw_on"), bounds(150, 10, 70, 40), text("Wraw_On"), colour:0("black"), colour:1("green")
button channel("Wave_fine_on"), bounds(230, 10, 70, 40), text("Wfine_On"), colour:0("black"), colour:1("green")
button channel("Wave_raw_detune_on"), bounds(150, 50, 70, 40), text("Wrawd_On"), colour:0("black"), colour:1("green")
button channel("Wave_fine_detune_on"), bounds(230, 50, 70, 40), text("Wfined_On"), colour:0("black"), colour:1("green")
;gentable bounds(10, 90, 380, 200), channel("wave_raw"), sampleRange(0, 10), ampRange(-1, 1, 1), outlineThickness(3), tableNumber(1.0), tableGridColour(155, 155, 155, 255) tableBackgroundColour(0,0,0,0) tableColour:0(147, 210, 0, 255)
button channel("Distance_detune"), bounds(310, 10, 70, 40), text("Dist_detun"), colour:0("black"), colour:1("green")
button channel("Fft_bank"), bounds(310, 50, 70, 40), text("FFT bank"), colour:0("black"), colour:1("green")
button channel("Fader_bank"), bounds(310, 90, 70, 40), text("Fader bank"), colour:0("black"), colour:1("green")
...
button channel("Stopchord"), bounds(400, 220, 70, 40), text("Stopchord"), colour:0("black"), colour:1("green")

csoundoutput bounds(390, 300, 380, 200)
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
...
instr 1
  ...
  kdistance_detune_on chnget "Distance_detune"
  ButtonEvent kdistance_detune_on, 12
